...
$( document ).ready(function() {
    ...
    $("#create-render-btn").click(function()
        {
            //e.preventDefault();
               ...
               /* const web3Instance = new Web3(window['ethereum']);
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $.showNotification({
                            body:"<h3>" + "Render started successfully." + "</h3>",
                            duration: 300000,
                            maxWidth:"820px",
    ...
    function validateFields(){
        ...
        if(localStorage.getItem('fileName') == ''){
          ...
          //e.preventDefault();   
            ...
            validationStatus = false;
            $.showNotification({
                body:"<h3>Please enter start frame.</h3>"
          })
        }else if(assetSymbol == ''){
            validationStatus = false;
            $.showNotification({
                body:"<h3>Please enter end frame.</h3>"
          })
        }  
